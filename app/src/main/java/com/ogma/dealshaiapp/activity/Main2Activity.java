...
//        //Use a custom button with an onClickListener to call the LoginManager directly
    ...
    private class SampleLoginCallback implements LoginCallback {
        ...
        public void onLoginCancel() {
            Toast.makeText(Main2Activity.this, "Login cancelled", Toast.LENGTH_LONG).show();
        }
        ...
        public void onAuthorizationCodeReceived(@NonNull String authorizationCode) {
            Toast.makeText(Main2Activity.this, "Your Auth code is: "+authorizationCode,
                    Toast.LENGTH_LONG)
                    .show();
        }
    }
                ...
                .enqueue(new Callback<UserProfile>() {
                    ...
                    public void onResponse(Call<UserProfile> call, Response<UserProfile> response) {
                        if (response.isSuccessful()) {
                            Toast.makeText(Main2Activity.this, "Welcome "+ response.body().getFirstName(),Toast.LENGTH_LONG).show();
                        } else {
                            ApiError error = ErrorParser.parseError(response);
                            Toast.makeText(Main2Activity.this, error.getClientErrors().get(0).getTitle(), Toast.LENGTH_LONG).show();
                        }
                    }
